...
// NextWishlistId is a free data retrieval call binding the contract method 0xf54b03b2.
//
// Solidity: function nextWishlistId() view returns(uint256)
func (_WishlistFactory *WishlistFactoryCaller) NextWishlistId(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _WishlistFactory.contract.Call(opts, &out, "nextWishlistId")
...
//
// Solidity: function nextWishlistId() view returns(uint256)
func (_WishlistFactory *WishlistFactorySession) NextWishlistId() (*big.Int, error) {
	return _WishlistFactory.Contract.NextWishlistId(&_WishlistFactory.CallOpts)
}

// NextWishlistId is a free data retrieval call binding the contract method 0xf54b03b2.
//
// Solidity: function nextWishlistId() view returns(uint256)
func (_WishlistFactory *WishlistFactoryCallerSession) NextWishlistId() (*big.Int, error) {
	return _WishlistFactory.Contract.NextWishlistId(&_WishlistFactory.CallOpts)
}
